...
public:
  ...
  /// Parses the source operands of an instruction and outputs a string
  /// representaion of it's symbolic value.
  std::string parse_source(Instruction instr, size_t operand_index);
  /// Parses the destination operand of an instruction and outputs a string
  /// representaion of it's symbolic value.
