...
public:
    ...
    /// Constructor for an Instruction that takes as input a line from disassembly output of `objdump` command.
    /// Assumes AT&T syntax.
    /// Example input: `100003f3f:	48 8b 7d f8          	mov    -0x8(%rbp),%rdi`
